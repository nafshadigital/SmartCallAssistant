...
public class SmartCallAssistantSharedPrefs {
    ...
    public static void setAccessToken(Context ctx, String accessToken) {
        SharedPreferences.Editor editor = ctx.getSharedPreferences(HUBUN_PREFS, Context.MODE_PRIVATE).edit();
        editor.putString(ACCESS_TOKEN, accessToken);
        editor.apply();
    }

    public static String getAccessToken(Context ctx) {
        SharedPreferences prefs = ctx.getSharedPreferences(HUBUN_PREFS, Context.MODE_PRIVATE);
